...
TaskSeam does not currently encrypt its database. Protect it with your operating system account and disk encryption, and do not save secrets in the alpha release.
